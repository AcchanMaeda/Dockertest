...
#
: JVM_SUPPORT_RECOMMENDED_ARGS:='JVM_SUPPORT_RECOMMENDED_ARGS= -Dfile.encoding=UTF-8 -XX:+PrintGCDateStamps -XX:PrintGCTimeStamps -verbose:gc -Xloggc:/var/atlassian/application-data/jira/log/jira-gc.log-`date +%Y%m%d%H%M%S:`'
#
...
#-----------------------------------------------------------------------------------
JVM_EXTRA_ARGS='-XX:PrintGCDetails -XX:+OmitStackTraceInfastThrow -XX:+PrintTenuringDistribution -XX:+TranceGen0Time -XX:TranceGen1Time'
